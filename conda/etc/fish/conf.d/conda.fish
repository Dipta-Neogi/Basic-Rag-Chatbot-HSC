set -gx CONDA_EXE (cygpath "E:/interviews/HSC chatbot/Basic-Rag-Chatbot-HSC/conda\Scripts\conda.exe")
set _CONDA_ROOT (cygpath "E:/interviews/HSC chatbot/Basic-Rag-Chatbot-HSC/conda")
set _CONDA_EXE (cygpath "E:/interviews/HSC chatbot/Basic-Rag-Chatbot-HSC/conda\Scripts\conda.exe")
set -gx CONDA_PYTHON_EXE (cygpath "E:/interviews/HSC chatbot/Basic-Rag-Chatbot-HSC/conda\python.exe")
